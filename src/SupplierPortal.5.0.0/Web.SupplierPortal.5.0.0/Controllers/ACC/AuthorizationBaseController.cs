...
namespace com.Sconit.Web.Controllers.ACC
{
    ...
    public class AuthorizationBaseController : WebAppBaseController
    {
        ...
        protected static string selectPermissionCategoryStatement = "select pc from PermissionCategory as pc where pc.Type = ?";
        ...
        protected PermissionCategory Prepare4AssignPermissions()
        {
            ...
            IList<PermissionCategory> permissionCategoryList = base.genericMgr.FindAll<PermissionCategory>(selectPermissionCategoryStatement, codeDetailList[0].Value);
            if (permissionCategoryList == null)
            {
                permissionCategoryList = new List<PermissionCategory>();
            }
