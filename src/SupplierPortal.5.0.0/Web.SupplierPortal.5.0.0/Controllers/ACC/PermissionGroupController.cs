...
namespace com.Sconit.Web.Controllers.ACC
{
    ...
    public class PermissionGroupController : AuthorizationBaseController
    {
        ...
        public ActionResult New(PermissionGroup pgroup)
        {
            ...
            {
                ////判断权限名不能重复
                if (base.genericMgr.FindAll<long>(userNameDuiplicateVerifyStatement, new object[] { pgroup.Code })[0] > 0)
                {
                    SaveErrorMessage(Resources.ACC.PermissionGroup.Errors_Existing_PermissionGroup, pgroup.Code.ToString());
                }
                else
                {
                    base.genericMgr.Create(pgroup);
        ...
        public ActionResult _Edit(int? id)
        {
            ...
            {
                PermissionGroup pgroup = base.genericMgr.FindById<PermissionGroup>(id);
        ...
        public ActionResult Delete(int? id)
        {
            ...
            {
                base.genericMgr.DeleteById<PermissionGroup>(id);
        ...
        public ActionResult _PermissionGroupUsers(int? id)
        {
            ...
            {
                ViewBag.AssignedUser = base.genericMgr.FindAll<User>(selectUsersByPermissionGroupId, id.Value);
                ViewBag.UnAssignedUser = base.genericMgr.FindAll<User>(selectUsersNotInPermissionGroup, id.Value);
                return PartialView();
            }
        }
        ...
        public ActionResult _PermissionGroupRole(int? id)
        {
            ...
            {
                ViewBag.AssignedRoles = base.genericMgr.FindAll<Role>(selectRoleByPermissionGroupId, id.Value);
                ViewBag.UnAssignedRoles = base.genericMgr.FindAll<Role>(selectRolesNotInPermissionGroup, id.Value);
                return PartialView();
            }
        }
        ...
        public ActionResult _AjaxLoadingPermissions(int permissiongroupId, string permissionCategoryCode)
        {
            return new JsonResult
            {
                Data = new SelectList[]
                {
                    new SelectList(base.genericMgr.FindAll<Permission>(selectPermissionsNotInPermissionGroupsByCategory , new object[] { permissionCategoryCode, permissiongroupId, permissionCategoryCode }), "Id", "Description"),
                                        new SelectList(base.genericMgr.FindAll<Permission>(selectPermissionsByPermissionGroupIdAndCategory , new object[] { permissionCategoryCode, permissiongroupId }), "Id", "Description")
                }
            };
        }
