...
begin tran
	...
	from ORD_OrderMstr_1 as mstr inner join #temp1 as t on mstr.Flow = t.Flow and substring(convert(varchar(20), Seq), 0, 9) = substring(convert(varchar(20), @NewSeq), 0, 9)--CONVERT(varchar(8), mstr.StartTime, 112) = t.StartTime
	...
	from ORD_OrderMstr_2 as mstr inner join #temp2 as t on mstr.Flow = t.Flow and substring(convert(varchar(20), Seq), 0, 9) = substring(convert(varchar(20), @NewSeq), 0, 9)--and CONVERT(varchar(8), mstr.StartTime, 112) = t.StartTime
	where mstr.OrderNo <> t.OrderNo and mstr.Seq >= @NewSeq;
	...
	from ORD_OrderMstr_4 as mstr inner join #temp4 as t on mstr.Flow = t.Flow and substring(convert(varchar(20), Seq), 0, 9) = substring(convert(varchar(20), @NewSeq), 0, 9)--and CONVERT(varchar(8), mstr.StartTime, 112) = t.StartTime
	where mstr.OrderNo <> t.OrderNo and mstr.Seq >= @NewSeq;
	...
	from ORD_OrderMstr_8 as mstr inner join #temp8 as t on mstr.Flow = t.Flow and substring(convert(varchar(20), Seq), 0, 9) = substring(convert(varchar(20), @NewSeq), 0, 9)--and CONVERT(varchar(8), mstr.StartTime, 112) = t.StartTime
	where mstr.OrderNo <> t.OrderNo and mstr.Seq >= @NewSeq;
commit
