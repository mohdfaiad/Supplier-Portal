/****** Object:  StoredProcedure [dbo].[USP_GetDocNo_VEH]    Script Date: 07/05/2012 14:55:19 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF EXISTS(SELECT * FROM SYS.objects WHERE type='P' AND name='USP_GetDocNo_VEH')
	DROP PROCEDURE USP_GetDocNo_VEH
