...
BEGIN
	...
	SET @Statement=N'INSERT INTO INV_LocationLotDet_'+@PartSuffix+'(Id,Version,Location,Bin,Item,LotNo,HuId,Qty,IsCS,PlanBill,CSSupplier,QualityType,IsFreeze,IsATP,OccupyType,OccupyRefNo,CreateUser,CreateUserNm,CreateDate,LastModifyUser,LastModifyUserNm,LastModifyDate) VALUES (@Id_1,@Version_1,@Location_1,@Bin_1,@Item_1,@LotNo_1,@HuId_1,@Qty_1,@IsCS_1,@PlanBill_1,@QualityType_1,@IsFreeze_1,@IsATP_1,@OccupyType_1,@OccupyRefNo_1,@CreateUser_1,@CreateUserNm_1,@CreateDate_1,@LastModifyUser_1,@LastModifyUserNm_1,@LastModifyDate_1)'
