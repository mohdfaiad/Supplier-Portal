...
/****** Object:  StoredProcedure [dbo].[USP_Search_RecDetCount]    Script Date: 01/01/2013 12:00:50 ******/
SET ANSI_NULLS ON
GO
...
IF EXISTS(SELECT * FROM sys.objects WHERE type='P' AND name='USP_Search_RecDetCount')
	DROP PROCEDURE USP_Search_RecDetCount
GO	
