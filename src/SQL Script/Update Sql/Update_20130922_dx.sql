...
go
insert into SYS_Menu values('Url_MiscOrder_261And262Import','261262批导','Menu.Inventory.Trans',350,'261262批导','~/OutMiscOrder/Import','~/Content/Images/Nav/Default.png',1)
go
insert into ACC_Permission values('Url_MiscOrder_261And262Import','261262批导','Inventory')
