...
/****** Object:  View [dbo].[VIEW_OrderDet]    Script Date: 04/23/2013 10:05:35 ******/
SET ANSI_NULLS ON
GO
...
SELECT     Id, OrderNo, Seq, ExtNo, ExtSeq, StartDate, EndDate, ScheduleType, Item, ItemDesc, RefItemCode, Uom, UC, Container, QualityType, ReqQty, OrderQty, ShipQty, 
                      ...
                      ContainerDesc, IsScanHu, BinTo, WMSSeq, IsChangeUC, AUFNR, ICHARG, BWART
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'VIEW_OrderDet'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'VIEW_OrderDet'
GO
