IF EXISTS(SELECT * FROM sys.objects WHERE type='P' AND name='USP_Search_ProcurementOrderDet') 
     DROP PROCEDURE USP_Search_ProcurementOrderDet

/****** Object:  StoredProcedure [dbo].[USP_Search_ProcurementOrderDet]    Script Date: 11/26/2012 13:58:36 ******/
SET ANSI_NULLS ON
GO
