...
/****** Object:  StoredProcedure [dbo].[USP_Search_IpDet]    Script Date: 2013-01-02 12:35:54 ******/
SET ANSI_NULLS ON
GO
...
IF EXISTS(SELECT * FROM sys.objects WHERE type='P' AND name='USP_Search_IpDet')
	DROP PROCEDURE USP_Search_IpDet
GO	
