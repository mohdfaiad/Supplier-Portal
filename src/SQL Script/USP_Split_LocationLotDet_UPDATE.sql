...
BEGIN
	...
	exec sp_executesql @Statement,@Parameter,
		...
		@IsCS_1=@IsCS,@PlanBill_1=@PlanBill,@PlanBill_1=@PlanBill,@CSSupplier_1=@CSSupplier,@QualityType_1=@QualityType,@IsFreeze_1=@IsFreeze,@IsATP_1=@IsATP,@OccupyType_1=@OccupyType,
