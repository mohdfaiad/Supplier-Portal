			...
			begin try
				...
				begin
					...
					begin  --正常排序件
						...
						UCDesc, Container, ContainerDesc, MrpTotal, MrpTotalAdj, MrpWeight, LocFrom, LocTo, Routing)
						select fdet.Flow as Flow, fdet.Item, i.Desc1 as ItemDesc, i.RefCode as RefItemCode, fdet.Uom, fdet.UC, fdet.MinUC,
						fdet.UCDesc, fdet.Container, fdet.ContainerDesc, fdet.MrpTotal, fdet.MrpTotalAdj, fdet.MrpWeight, mstr.LocFrom, mstr.LocTo, fdet.Routing
						...
						rDet.UCDesc, rDet.Container, rDet.ContainerDesc, rDet.MrpTotal, rDet.MrpTotalAdj, rDet.MrpWeight, mstr.LocFrom, mstr.LocTo, rDet.Routing
						...
						begin
							insert into #tempBomCPTime(OrderNo, TraceCode, Seq, SubSeq, CPTime, Flow, Item, ItemDesc, RefItemCode, Uom, UC, MinUC, UCDesc, Container, ContainerDesc, OpRef, OrderQty, Location, BomId, ManufactureParty, LocFrom, LocTo, Routing, ZOPWZ, ZOPID, ZOPDS)
							select bom.OrderNo, seq.TraceCode, seq.Seq, seq.SubSeq, cp.CPTime, CASE WHEN flow.Flow is not null THEN flow.Flow ELSE fdet.Flow END as Flow, bom.Item, fdet.ItemDesc, fdet.RefItemCode, fdet.Uom, fdet.UC, fdet.MinUC, fdet.UCDesc, fdet.Container, fdet.ContainerDesc, bom.OpRef, bom.OrderQty, bom.Location, bom.Id, bom.ManufactureParty, fdet.LocFrom, fdet.LocTo, fdet.Routing, bom.ZOPWZ, bom.ZOPID, bom.ZOPDS
					...
					begin  --鞍座和变速器按工作中心找排序件
						...
						begin
							...
							truncate table #tempBomCPTime
							insert into #tempBomCPTime(OrderNo, TraceCode, Seq, SubSeq, CPTime, Flow, Item, ItemDesc, RefItemCode, Uom, UC, MinUC, UCDesc, Container, ContainerDesc, OpRef, OrderQty, Location, BomId, ManufactureParty, LocFrom, LocTo, Routing, ZOPWZ, ZOPID, ZOPDS)
							select bom.OrderNo, seq.TraceCode, seq.Seq, seq.SubSeq, cp.CPTime, @WMSKitOrderSeqFlow as Flow, bom.Item, i.Desc1 as ItemDesc, i.RefCode as RefItemCode, i.Uom, i.UC, i.MinUC, null, i.Container, i.ContainerDesc, bom.OpRef, bom.OrderQty, bom.Location, bom.Id, bom.ManufactureParty, mstr.LocFrom, mstr.LocTo, null, bom.ZOPWZ, bom.ZOPID, bom.ZOPDS
							from ORD_OrderBomDet as bom
					...
					begin
						--记录日志
						if not exists(select top 1 1 from #tempFlowDet)
						begin
							set @Msg = N'没有设置排序零件'
							insert into #temp_LOG_GenSequenceOrder(SeqGroup, Lvl, Msg) values(@SeqGroup, 0, @Msg)
						end
							...
							begin   --首台车排序件的消耗时间 - 提前期是否大于当前时间
								...
								begin try
									...
									begin
										...
										Uom, UC, MinUC, UCDesc, Container, ContainerDesc, ManufactureParty, OpRef, CPTime, IsCreateSeq, ZOPWZ, ZOPID, ZOPDS, IsItemConsume, Routing)
										...
										bom.Uom, bom.UC, bom.MinUC, bom.UCDesc, bom.Container, bom.ContainerDesc, bom.ManufactureParty, bom.OpRef, bom.CPTime, ord.IsCreateSeq, bom.ZOPWZ, bom.ZOPID, bom.ZOPDS, 0, bom.Routing
										from
													...
													begin
														...
														begin
															...
															select @SeqRowSeq + 1, TraceCode, VanSeq, 
																						...
																						Uom, UC, MinUC, UCDesc, Container, ContainerDesc, ManufactureParty, OpRef, CPTime, IsCreateSeq, ZOPWZ, ZOPID, ZOPDS, 1, Routing
