...
IF EXISTS(SELECT * FROM sys.objects WHERE type='P' AND name='USP_Search_PrintRecDet') 
     DROP PROCEDURE USP_Search_PrintRecDet 
GO 
...
BEGIN 
	...
	SET @DetailWhere=' WHERE 1=1 and d.IpDetType<>1 ' 
