...
{
    public class RepLogisticOrderDetViewOperator : RepTemplate1
    {
        public RepLogisticOrderDetViewOperator()
        {
            //明细部分的行数
            ...
            try
            {
              ...
              //  PrintOrderMaster orderMaster = (PrintOrderMaster)(list[0]);
               ...
               // orderDetails = orderDetails.OrderBy(o => o.Sequence).ThenBy(o => o.Item).ToList();
                ...
                this.pageDetailRowCount = orderDetailList.Count;
               ...
               // this.barCodeFontName = this.GetBarcodeFontName(2, 8);
                ...
                foreach (OrderDetail printOrderDetail in orderDetailList)
                {
                    ...
                    //零件号 Item Code
                    this.SetRowCell(pageIndex, rowIndex, 2, printOrderDetail.ExternalOrderNo);

                    //参考号 Ref No.
                    this.SetRowCell(pageIndex, rowIndex, 3, printOrderDetail.ExternalSequence);
                    ...
                    this.SetRowCell(pageIndex, rowIndex, 20, printOrderDetail.SAPLocation);
                    this.SetRowCell(pageIndex, rowIndex, 21, printOrderDetail.OrderStrategyDescription);

                   
                    this.SetRowCell(pageIndex, rowIndex, 22, printOrderDetail.MastCreateDate.ToString("yyyy-MM-dd"));
                    this.SetRowCell(pageIndex, rowIndex, 23, printOrderDetail.MastWindowTime.ToString("yyyy-MM-dd HH:mm:ss"));
