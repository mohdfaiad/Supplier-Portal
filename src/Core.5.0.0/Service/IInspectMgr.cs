...
{
    public interface IInspectMgr : ICastleAwarable
    {
        #region 创建报验单
        ...
        #region 让步使用单创建
        void CreateConcessionMaster(ConcessionMaster concessionMaster);
        #endregion
        ...
        #region 报验单让步使用
        //RejectMaster CreateConcession(string handleResult, IList<InspectResult> inspectResultList);
        //#endregion
        //#region 报验单移库
        //RejectMaster CreateRejectTransfer(Location location,string handleResult, IList<InspectResult> inspectResultList);
        //#endregion
        //#region 报验单退货
        void CreateReturnOrder(MiscOrderMaster miscOrderMaster, string handleResult, IList<InspectResult> inspectResultList);
        ConcessionMaster CreateConssionOrder(ConcessionMaster concessionMaster);
        #endregion
    }
}
