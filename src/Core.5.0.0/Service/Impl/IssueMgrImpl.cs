...
namespace com.Sconit.Service.Impl
{
    ...
    public class IssueMgrImpl : BaseMgr, IIssueMgr
    {
        ...
        public IList<IssueMaster> GetIssueMasterByIssueAddress(string issueAddress)
        {
            ...
            return this.genericMgr.FindAll<IssueMaster>(criteria);
        }
        ...
        public void SendIssue()
        {
            try
            {
                ...
                //if ((issueLevelsSubmit == null || issueLevelsSubmit.Count <= 1)
                //    && (issueLevelsInprocess == null || issueLevelsInprocess.Count <= 1)) return;
        ...
        private IList<IssueDetail> GetIssueDetail(string status)
        {
            try
            {
                ...
                IList<IssueDetail> issueDetailList = this.genericMgr.FindAll<IssueDetail>(criteria);
        ...
        public IList<IssueMaster> GetIssueMaster(string[] status)
        {
            ...
            IList<IssueMaster> issueList = genericMgr.FindAll<IssueMaster>(criteria);
