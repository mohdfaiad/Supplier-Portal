...
{
    public interface ILocationDetailMgr : ICastleAwarable
    {
        ...
        Boolean CanInventoryOccupy(string supplier, string location, string item, CodeMaster.QualityType qualityType, decimal qty);

        decimal GetAvailableInventoryOccupied(CodeMaster.OccupyType occupyType, string occupyNo, string supplier, string location, string item, CodeMaster.QualityType qualityType);

        IList<LocationLotDetail> InventoryOccupy(CodeMaster.OccupyType occupyType, string occupyNo, string supplier, string location, string item, CodeMaster.QualityType qualityType, decimal qty);

        IList<LocationLotDetail> CancelInventoryOccupy(CodeMaster.OccupyType occupyType, string occupyNo, string supplier, string location, string item, CodeMaster.QualityType qualityType, decimal qty);
        ...
        IList<InventoryTransaction> BackflushVanProductMaterial(IList<BackflushInput> backflushInputList);

        #region 安全库存导入
        void ImportLocDetPrefXls(Stream inputStream);
        #endregion
    }
}
