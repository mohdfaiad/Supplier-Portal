...
{
    [Serializable]
    public partial class CreateScheduleLine : EntityBase, ITraceable
    {
        ...
        [Display(Name = "CRSL_ETENR", ResourceType = typeof(Resources.SI.CRSL))]
        ...
        {
            CreateScheduleLine another = obj as CreateScheduleLine;
