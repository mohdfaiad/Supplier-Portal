...
namespace com.Sconit.Entity.INV
{
    ...
    public partial class LocationTransaction : EntityBase
    {
        ...
        [Export(ExportName = "ExportList", ExportSeq = 30)]
        ...
        [Export(ExportName = "ExportList", ExportSeq = 40)]
        ...
        [Export(ExportName = "ExportList", ExportSeq = 50)]
        ...
        [Export(ExportName = "ExportList", ExportSeq = 100)]
      ...
      [Display(Name = "LocationTransaction_Uom", ResourceType = typeof(Resources.INV.LocationTransaction))]
        ...
        [Export(ExportName = "ExportList", ExportSeq = 140)]
		...
		//[Display(Name = "QualityType", ResourceType = typeof(Resources.INV.LocationTransaction))]
		public com.Sconit.CodeMaster.QualityType QualityType { get; set; }
        [Export(ExportName = "ExportList", ExportSeq = 120)]
        [Display(Name = "LocationTransaction_HuId", ResourceType = typeof(Resources.INV.LocationTransaction))]
		public string HuId { get; set; }
        [Export(ExportName = "ExportList", ExportSeq = 130)]
        ...
        [Export(ExportName = "ExportList", ExportSeq = 60)]
        ...
        [Export(ExportName = "ExportList", ExportSeq = 70)]
        ...
        [Export(ExportName = "ExportList", ExportSeq = 80)]
        ...
        [Export(ExportName = "ExportList", ExportSeq = 90)]
        ...
        [Export(ExportName = "ExportList", ExportSeq = 20)]
