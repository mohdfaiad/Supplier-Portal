...
namespace com.Sconit.Entity.SCM
{
    ...
    public partial class FlowBinding : EntityBase, IAuditable
    {
        ...
        [Display(Name = "FlowBinding_JointOpRefrence", ResourceType = typeof(Resources.SCM.FlowBinding))]
        public int? JointOpReference { get; set; }
        [Display(Name = "FlowBinding_LeadTime", ResourceType = typeof(Resources.SCM.FlowBinding))]
