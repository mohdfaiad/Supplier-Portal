...
namespace com.Sconit.Entity.SCM
{
    ...
    public partial class FlowMaster : EntityBase, IAuditable
    {
        ...
        [Display(Name = "FlowMaster_TaktTime", ResourceType = typeof(Resources.SCM.FlowMaster))]
        public Int32 TaktTime { get; set; }

        [Display(Name = "FlowMaster_VirtualOpReference", ResourceType = typeof(Resources.SCM.FlowMaster))]
        public string VirtualOpReference { get; set; }
