...
namespace com.Sconit.Entity.PRD
{
    ...
    public partial class ShiftAll : EntityBase
    {
        ...
        [Required(AllowEmptyStrings = false, ErrorMessageResourceName = "Errors_Common_FieldRequired", ErrorMessageResourceType = typeof(Resources.ErrorMessage))]
        [StringLength(256, ErrorMessageResourceName = "Errors_Common_FieldLengthExceed", ErrorMessageResourceType = typeof(Resources.ErrorMessage))]
        [RegularExpression("^(([1-9]{1})|([0-1][0-9])|([1-2][0-3])):([0-5][0-9])-(([1-9]{1})|([0-1][0-9])|([1-2][0-3])):([0-5][0-9])$", ErrorMessageResourceName = "Errors_Form_ShiftTime", ErrorMessageResourceType = typeof(Resources.MD.WorkingCalendar))]
