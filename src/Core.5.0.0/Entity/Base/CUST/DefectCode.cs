...
namespace com.Sconit.Entity.CUST
{
    ...
    public partial class DefectCode : EntityBase, IAuditable
    {
		...
		//[Display(Name = "LastModifyUserId", ResourceType = typeof(Resources.CUST.DefectCode))]
		public Int32 LastModifyUserId { get; set; }
		//[Display(Name = "LastModifyUserName", ResourceType = typeof(Resources.CUST.DefectCode))]
		public string LastModifyUserName { get; set; }
		//[Display(Name = "LastModifyDate", ResourceType = typeof(Resources.CUST.DefectCode))]
