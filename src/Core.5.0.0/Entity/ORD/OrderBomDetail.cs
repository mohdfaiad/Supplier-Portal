...
namespace com.Sconit.Entity.ORD
{
    public partial class OrderBomDetail
    {
        ...
        [Export(ExportName = "OrderBomDetail", ExportSeq = 141)]
        ...
        [Export(ExportName = "OrderBomDetail", ExportSeq = 151)]
        ...
        [Export(ExportName = "OrderBomDetail", ExportSeq = 161)]
        [Display(Name = "OrderBomDetail_IsAutoFeed", ResourceType = typeof(Resources.ORD.OrderBomDetail))]
        public string IsAutoFeedDescription
        {
            get { return IsAutoFeed ? Resources.Global.True : Resources.Global.False; }
        }
        #endregion
    }
}